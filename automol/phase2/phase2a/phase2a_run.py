...
def run_Phase_2a(input_text, optimization_steps, score_threshold, technical_descriptions, predicted_structures_dir, results_dir):
    ...
    for i, desc in enumerate(technical_descriptions):
        ...
        while attempts < max_attempts:
            ...
            optimized_results = run_optimization_pipeline([generated_sequence], iterations=optimization_steps, score_threshold=score_threshold)
            if optimized_results:
                ...
                for opt_result in optimized_results:
                    ...
                    if optimized_score > best_score:
                        ...
                        prediction_results = run_prediction_pipeline([optimized_sequence], output_dir=predicted_structures_dir)
    ...
    set_protein_sequences(all_generated_sequences)
...
def main():
    ...
    try:
        protein_sequences = run_Phase_2a(
            technical_descriptions,
