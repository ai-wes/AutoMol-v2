...
from automol.phase2.phase2b.pre_screen_compounds import pre_screen_ligand, screen_and_store_ligand_mongo
import torch
...
class StructurePredictor:
    ...
    def predict_3d_ligand_structure(self, sequence):
        return self.predict(sequence, ".")  # Use current directory as output_dir

    @checkpoint("Protein Structure Prediction")
    def predict_ligand_structure(self, sequence: str, output_dir: str) -> str:
        """
